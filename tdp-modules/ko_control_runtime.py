"""Compatibility import for :mod:`tvcgui.runtime.ko_control`.

New code should import from ``tvcgui.runtime.ko_control``.
"""
from tvcgui.runtime.ko_control import *  # noqa: F401,F403
...
import tvcgui.runtime.ko_control as _implementation
