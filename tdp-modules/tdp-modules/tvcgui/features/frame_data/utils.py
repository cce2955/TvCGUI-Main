...
from tvcgui.features.combat.moves import CHAR_ID_CORRECTION
...
try:
    from tvcgui.tools.scanners.normal_scanner import ANIM_MAP as _ANIM_MAP_FOR_GUI
except Exception:
    _ANIM_MAP_FOR_GUI = {}

try:
    from tvcgui.platform.dolphin import rdf32
except Exception:
    rdf32 = None

WRITER_AVAILABLE = False
try:
    from tvcgui.features.combat.move_writer import (
        write_damage,
        write_meter,
        write_active_frames,
        write_hitstun,
...
def resolve_projectile_fields_for_move(
    ...
    *,
    ...
    if rbytes_func is None:
        try:
            from tvcgui.platform.dolphin import rbytes as rbytes_func  # type: ignore
        except Exception:
            return False
...
def resolve_projectile_radius_for_move(
    ...
    *,
    ...
    try:
        from .patterns import find_projectile_radius_addr
