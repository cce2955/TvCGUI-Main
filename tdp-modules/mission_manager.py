...
class MissionManager:
    ...
    def write_mode_state(self) -> None:
        if not self._active_slot:
            if self._runtime.get("saved_meter_flag_mission") in {"ryu_008", "saki_009"}:
    ...
    def _augment_payload_with_runtime(self, payload: dict, snaps_dict: dict) -> dict:
        ...
        if mission_id in {"ryu_008", "saki_009"}:
            ...
            if self._runtime.get("saved_meter_flag_mission") != "ryu_008":
                ...
                self._runtime["saved_meter_flag_mission"] = "ryu_008"
