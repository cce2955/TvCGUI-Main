import pygame
from tvcgui.core.config import COL_PANEL, COL_BORDER, COL_TEXT
from tvcgui.core.events import event_log
from tvcgui.features.combat.move_id_map import lookup_move_name  # NEW
import math

from tvcgui.tools.scanners.special_runtime_finder import get_special_anims
try:
