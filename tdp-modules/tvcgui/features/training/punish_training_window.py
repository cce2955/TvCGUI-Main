...
def open_punish_training_window(
    ...
    def _open(tk_root: tk.Misc | None = None) -> None:
        ...
        _label(
            h,
            'Choose a fighter slot and move. The selected interval counts down first, then the move executes.',
            muted=True,
        ...
        _label(cooldown_row, 'seconds before each move', muted=True).pack(side='left', padx=(8, 0))
        ...
        _label(range_row, 'seconds before each move', muted=True).pack(side='left', padx=(8, 0))
