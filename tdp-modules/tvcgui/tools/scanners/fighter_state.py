...
from tvcgui.platform.dolphin import rd32, rd8, rdf32
from tvcgui.tools.scanners.fighter_resolver import looks_like_hp
...
from tvcgui.core.config import WIRE_OFFSETS, HEALTH_WIRE_OFFSETS
from tvcgui.features.combat.moves import read_attack_ids
